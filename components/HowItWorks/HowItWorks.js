...
const HowItWorks = ({ isCloseButtonShown }) => (
  ...
  <div className={styles['how-it-works']}>
    <p>
      Este proyecto sale de la necesidad de escribir pequeñas <strong>notitas </strong>
      (apuntes, comentarios, puntos de entrevista etc) y no querer abrir aplicaciones
      cómo Notion o similares por optimizar espacios de ventanas así cómo recursos
      del ordenador. También quería aprender a usar framer-motion de paso.
    </p>
